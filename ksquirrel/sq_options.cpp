...
**
** Created: Срд Янв 21 12:40:49 2004
...

{
    ...
    checkBox3->setGeometry( QRect( 10, 40, 94, 20 ) );
    checkBox3->setChecked( TRUE );

    buttonGroup1 = new QButtonGroup( page_2, "buttonGroup1" );
    buttonGroup1->setGeometry( QRect( 30, 70, 120, 60 ) );
    ...
    checkBox4->setGeometry( QRect( 40, 140, 139, 20 ) );
    checkBox4->setChecked( TRUE );
    checkBox4->setTristate( FALSE );

    checkBox1 = new QCheckBox( page_2, "checkBox1" );
    checkBox1->setGeometry( QRect( 10, 10, 136, 20 ) );
...
void SQ_Options::languageChange()
{
    ...
    checkBox1->setText( tr2i18n( "don't load tree view" ) );
}
