...
case $AUTOCONF_VERSION in
  ...
  "" )
    ...
    echo "*** KDE requires autoconf 2.52 or higher"
    exit 1
    ;;
  * )
...
case $AUTOHEADER_VERSION in
  ...
  "" )
    ...
    echo "*** KDE requires autoheader 2.52 or higher (part of autoconf)"
    exit 1
    ;;
  * )
...
case $AUTOMAKE_STRING in
  automake*1.5d* )
    ...
    echo "*** KDE requires automake 1.5 or higher"
    exit 1
    ;;
  automake*1.5* | automake*1.5-* | automake*1.6.* | automake*1.7* | automake*1.8* ) : ;;
  "" )
    echo "*** AUTOMAKE NOT FOUND!."
    echo "*** KDE requires automake 1.6 or higher"
    exit 1
    ;;
  unsermake* ) :
